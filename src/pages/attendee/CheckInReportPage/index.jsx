...
const CheckInReportPage = () => {
    ...
    const totalCheckInPercent = useMemo(() => {
        ...
        return Math.round((reportData.checkedInQuantity + reportData.guestCheckedInQuantity) /
            (reportData?.soldQuantity + reportData?.guestInvitedQuantity) * 100);
    }, [reportData]);
                    ...
                    <div className="md:col-span-1 bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        <div className="space-y-2">
                            ...
                            <p className="text-2xl font-bold text-gray-900">
                                {reportData?.checkedInQuantity + reportData?.guestCheckedInQuantity || 0} vé
                            </p>
                            <p className="text-sm text-gray-500">
                                Tổng {reportData?.soldQuantity + reportData?.guestInvitedQuantity || 0} vé
                            </p>
                        </div>
                    ...
                    <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">
                                    {(reportData?.checkedInQuantity + reportData?.guestCheckedInQuantity) -
                                        (reportData?.outsideQuantity + reportData?.guestOutsideQuantity) || 0}
                                </p>
                            </div>
                        </div>
