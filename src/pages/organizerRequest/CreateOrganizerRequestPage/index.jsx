...
import { OrganizerType } from '@/utils/constant';
...
const getSchema = (isEditMode) => {
    return z.object({
        businessName: z.string().min(1, { message: "Vui lòng nhập tên nhà tổ chức" }),
        type: z.enum([OrganizerType.ORGANIZATION, OrganizerType.PERSONAL], { required_error: "Vui lòng chọn loại hình tổ chức" }),
        taxCode: z.string().min(1, { message: "Vui lòng nhập mã số thuế" }),
...
const CreateOrganizerRequestPage = () => {
    ...
    const form = useForm({
        ...
        defaultValues: {
            businessName: "",
            type: "ORGANIZATION", // Set default value
            taxCode: "",          // Set default value
                ...
                try {
                    ...
                    if (response.code === HttpStatusCode.Ok) {
                        ...
                        form.reset({
                            ...
                            type: data.type || OrganizerType.ORGANIZATION,
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold tracking-tight">
                        {isEditMode ? "Cập nhật hồ sơ nhà Tổ chức" : "Đăng ký nhà Tổ chức"}
                    </h1>
                                ...
                                <div className="md:col-span-9 space-y-4">
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="space-y-2 col-span-2 md:col-span-2">
                                                    <FormLabel>Tên nhà Tổ chức <span className="text-destructive">*</span></FormLabel>
                                                    <FormControl>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="space-y-2">
                                                    <FormLabel>Loại hình <span className="text-destructive">*</span></FormLabel>
                                                    <Select onValueChange={field.onChange}
                                                        ...
                                                        <SelectContent>
                                                            <SelectItem value={OrganizerType.ORGANIZATION}>Tổ chức</SelectItem>
                                                            <SelectItem value={OrganizerType.PERSONAL}>Cá nhân</SelectItem>
                                                        </SelectContent>
                                                    </Select>
                                                    <FormMessage />
                                                </FormItem>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="space-y-2">
                                                    <FormLabel>Mã số thuế <span className="text-destructive">*</span></FormLabel>
                                                    <FormControl>
