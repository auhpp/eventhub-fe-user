...
const EditProfile = () => {
    ...
    return (
        <div className="space-y-6">
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="flex flex-col items-center justify-center gap-4 mb-6">
                                <div className="relative group">
                                    <Avatar className="w-32 h-32 border-4 object-cover border-white shadow-md cursor-pointer">
                                        <AvatarImage className="object-cover" src={previewAvatar} alt={user?.fullName} />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>{isOrganizer ? 'Tên nhà tổ chức' : 'Họ và tên'}</FormLabel>
                                        <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input readOnly={true} value={field.value || ''} className={primaryRingClass} />
                                            </FormControl>
                                        </FormItem>
                                    )}
                                />
            ...
            {
                user.role.name == RoleName.ORGANIZER.key &&
                <SocialLinksForm />
            }
        </div>
    );
