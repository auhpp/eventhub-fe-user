...
import { getEventChartStats, getEventStats } from '@/services/eventSessionService';
                    ...
                    <table className="w-full text-sm text-left">
                        <thead className="text-xs text-gray-500 bg-gray-50/50 border-b border-gray-100">
                            <tr>
                                ...
                                <th className="px-6 py-4 font-medium text-center">Bị khoá</th>
                                    ...
                                    <tr key={index} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors" >
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-xs font-semibold text-gray-600 min-w-[3ch]">{sellRate.toFixed(0)}%</span>
                                            </div>
                                        </td>
                                    </tr>
                                );
