...
const RevenueDetailsModal = ({ isOpen, onClose, data, event }) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={handleOpenChange}>
            <DialogContent className="p-0 overflow-hidden max-w-md gap-0 bg-white"
                        ...
                        <tbody>
                            <tr className="border-b border-gray-100 bg-gray-50/50">
                                <td className="p-4 pl-6 flex items-center gap-1">
                                    Doanh thu trước khuyến mãi <Info size={14} className="text-gray-400" />
                                </td>
                                <td className="p-4 text-right">{formatCurrency(totalRevenue)}</td>
                            </tr>
                            <tr className="border-b border-gray-100 bg-gray-50/50">
                                <td className="p-4 pl-6 flex items-center gap-1">
                                    Khuyến mãi <Info size={14} className="text-gray-400" />
                                </td>
