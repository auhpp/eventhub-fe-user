                ...
                <div className="flex items-center gap-8">
                    ...
                    <div className="hidden md:flex items-center relative w-64 lg:w-96">
                        ...
                        <input
                            ...
                            className="block w-full rounded-full border border-input bg-muted/50 py-1.5 
                            pl-10 pr-4 text-sm focus:border-brand focus:ring-1 focus:ring-brand outline-none transition-all"
                        ...
                        {isLoading ? (
                            ...
                            <>
                                <button
                                    ...
                                    className="flex h-9 items-center justify-center rounded-lg px-4 text-sm 
                                    font-bold text-foreground hover:bg-accent transition-colors">
                                    Đăng nhập
                                </button>
                                <button
                                    onClick={() => navigate(routes.signup)}
                                    className="flex h-9 items-center justify-center rounded-lg bg-brand px-4 
                                    text-sm font-bold text-white hover:bg-brand-dark shadow-sm transition-colors">
                                    Đăng ký
                                </button>
                            </>
                        ) : (
                            <div className="flex items-center gap-4">
                                {isOrganizer ? (
                                    ...
                                    <button
                                        ...
                                        py-1.5 text-sm font-medium text-white hover:bg-gray-800 transition-all shadow-sm"
                                    >
                                ...
                                >
                                    ...
                                    {unreadCount > 0 && (
                                        <span className="absolute top-0 right-0 h-2.5 w-2.5 rounded-full
                                         bg-red-500 border-2 border-white"></span>
                                    )}
                                </button>
                                ...
                                <div className="group relative">
                                    {/* Avatar Trigger */}
                                    <div className="relative flex items-center gap-2 cursor-pointer py-1 hover:bg-gray-100 px-1 rounded-lg">
                                        <Avatar className="h-9 w-9 rounded-full border border-gray-200 bg-gray-100 overflow-hidden
                                    ...
                                    <div className="absolute right-0 top-full mt-1 w-60 origin-top-right rounded-xl border border-gray-200
                                     ...
                                     group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2
                                      group-hover:translate-y-0 z-50">
                                        <Link to="/profile" className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium 
                                        text-gray-700 hover:bg-gray-100 hover:text-brand transition-colors">
                                            <User className="h-4 w-4" />
                                            Tài khoản của tôi
                                        </Link>

                                        <Link to={routes.myTicket} className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm 
